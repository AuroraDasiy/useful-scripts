...
def file_batch_processing():
    ...
    option_menu = ttk.Combobox(option_frame, textvariable=option_var, values=["修改扩展名", "删除文件"])
    ...
    # 确认按钮
    confirm_button = ttk.Button(popup, text="确认", command=lambda: execute_batch_operation(option_var.get(), entry1.get(), entry2.get()))
